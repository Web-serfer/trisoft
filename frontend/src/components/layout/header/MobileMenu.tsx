	...
	return (
		<a href="/" class="flex flex-col items-center no-underline">
			<div class="text-xl font-bold tracking-wider uppercase">
				<span
					style={{
						background: 'linear-gradient(45deg, #0891B2, #374151, #111827)',
			...
			<div class="text-xs tracking-widest text-gray-500">Ваш партнер 1С</div>
		</a>
	)
}
		...
		<>
			...
			>
				<div class="flex flex-shrink-0 items-center justify-between border-b border-gray-200 p-4 bg-white">
					...
					<a
						href="/login"
						class="bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-md shadow-lg hover:shadow-blue-500/25 transform hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center text-sm py-1.5 px-3"
					>
						Вход
					</a>
				</div>
